    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			 	<textarea name="claim.contents" id="claim_contents_edit" style="width:100%;height:500px;"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
...
<script>
//实例化编辑器
var claim_contents_edit = UE.getEditor('claim_contents_edit'); //描述说明编辑器
	...
	$.ajax({
		...
		success : function (claim, response, status) {
			if (claim) {
				...
				claim_contents_edit.setContent(claim.contents, false);
