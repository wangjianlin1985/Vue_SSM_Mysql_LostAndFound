...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">失物招领网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Claim/frontlist">认领记录</a></li>
                <li><a href="<%=basePath %>Praise/frontlist">表扬信</a></li>
                <li><a href="<%=basePath %>Notice/frontlist">站内新闻</a></li>
