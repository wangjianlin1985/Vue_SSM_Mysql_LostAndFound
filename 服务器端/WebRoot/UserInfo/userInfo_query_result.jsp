...
<div id="userInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="userInfoQueryForm" method="post">
			手机账号：<input type="text" class="textbox" id="user_name" name="user_name" style="width:110px" />
			...
			注册时间：<input type="text" id="regTime" name="regTime" class="easyui-datebox" editable="false" style="width:100px">
